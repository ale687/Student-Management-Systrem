...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Create a status bar and add starus bar elements
...
class AboutDialog(QMessageBox):
    def __init__(self):
        ...
        content = """
        This application is a student management system developed as a personal project to practice Python and PyQt6.
        """
...
class SearchDialog(QDialog):
    def __init__(self):
        ...
        self.student_name = QLineEdit()
        self.student_name.setPlaceholderText("Name")
        layaout.addWidget(self.student_name)
        
        # Create button
        button = QPushButton("Search")
        button.clicked.connect(self.search)
        layaout.addWidget(button)
